...
INSERT INTO inventory_records (id, product_id, biz_type, biz_id, change_qty, before_qty, after_qty, remark) VALUES
(1, 1, 'PURCHASE_INBOUND', 1, 20, 20, 40, '初始化采购入库'),
(2, 2, 'INITIAL', NULL, 55, 0, 55, '初始化库存'),
(3, 3, 'INITIAL', NULL, 18, 0, 18, '初始化库存');
