...
public class SalesController {
    ...
    public ApiResponse<SalesOrderItem> outbound(@PathVariable Long id) { return ApiResponse.success(salesService.outbound(id)); }

    @PostMapping("/{id}/payment")
    public ApiResponse<SalesOrderItem> payment(@PathVariable Long id, @Validated @RequestBody PaymentRequest request) { return ApiResponse.success(salesService.payment(id, request)); }
