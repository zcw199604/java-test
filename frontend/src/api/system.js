...
export const fetchWarehouseDetail = (id) => http.get(`/warehouses/${id}`)
export const createWarehouse = (payload) => http.post('/warehouses', payload)
export const updateWarehouse = (id, payload) => http.put(`/warehouses/${id}`, payload)
export const updateWarehouseStatus = (id, payload) => http.put(`/warehouses/${id}/status`, payload)
