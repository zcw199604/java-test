...
## 本次更新（2026-03-29）
- 销售管理中的“销售出库”独立路由页已移除，避免与销售订单页中的出库动作重复。
- 经营大屏已移除“导出预览”区块，仅保留一键导出能力与核心图表。
- 驾驶舱首页新增“历史烟品销售对比”图表，支持在近 7 天 / 30 天范围内查看重点烟品趋势。
- 图表支持“销售数量 / 销售金额”切换，页面已改为调用真实后端接口而非前端硬编码假数据。
